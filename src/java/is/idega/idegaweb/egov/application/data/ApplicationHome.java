...
public interface ApplicationHome extends IDOHome {
	...
	public Collection<Application> findAllByCasesIds(Collection<Integer> ids) throws FinderException;
	...
	Collection<Application> findAllWithPaymentRequired() throws FinderException;
}