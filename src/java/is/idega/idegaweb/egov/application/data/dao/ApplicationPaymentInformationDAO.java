/**
 * @(#)ApplicationPaymentInformationDAO.java    1.0.0 13:32:18
 *
...
/**
 * <p>Data access object for {@link ApplicationPaymentInformationEntity}</p>
 ...
 */
public interface ApplicationPaymentInformationDAO extends GenericDao {

	/**
	 * 
	 * <p>Updates or creates entity in data source;</p>
	 * @param id of entity, <code>null</code> when new entity should be created;
	 * @param applicationId is {@link Application#getPrimaryKey()}, 
	 * not <code>null</code> on creation of new entity;
	 * @param user who this settings belongs to, 
	 * not <code>null</code> on creation of new entity;
	 * @param active if this settings are applied at the time;
	 * @param creditCardEnding in 4 last digits of credit card info, 
	 * not <code>null</code> on creation of new entity;
	...
	/**
	 * 
	 * @param id is {@link ApplicationPaymentInformationEntity#getId()}, 
	 * not <code>null</code>;
	...
	/**
	 * 
	 * @return all entities from database or {@link Collections#emptyList()}
	 * on failure;
	 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
	 */
	public List<ApplicationPaymentInformationEntity> findAll();

	public Application findApplication(ApplicationPaymentInformationEntity entity);
}
