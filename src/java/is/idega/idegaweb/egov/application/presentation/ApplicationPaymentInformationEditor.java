/**
 * @(#)ApplicationPaymentInformationEditor.java    1.0.0 12:04:54
 *
...
/**
 * <p>Graphical editor for {@link ApplicationPaymentInformationEntity}</p>
 ...
 */
public class ApplicationPaymentInformationEditor extends IWBaseComponent {

	public static final String FACELET_FILENAME = "application_payment_information_editor.xhtml";
	...
	protected IWBundle getBundle() {
		if (bundle == null) {
			bundle = IWMainApplication.getDefaultIWMainApplication().getBundle(
					is.idega.idegaweb.egov.application.IWBundleStarter.IW_BUNDLE_IDENTIFIER);			
		}
